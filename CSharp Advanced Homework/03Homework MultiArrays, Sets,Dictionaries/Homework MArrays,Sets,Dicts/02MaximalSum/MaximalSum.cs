...
class MaximalSum
{
    ...
    {
        //there was a mistake in the assignment - rows and cows were given as 3 and 4, mistake was fixed download the new homework file
        //or don't judge it as a mistake
