...
angular.module('videoApp.services.videos',[])
    .factory('videos',[function(){
        ...
        var video3 = new Video('Applications JS','http://newtrend.bg/wp-content/uploads/2015/03/SoftUni-Logo.png',new VideoLength(2,15,17),'Java Script',48,15,new Date(2016,2,2),true);
