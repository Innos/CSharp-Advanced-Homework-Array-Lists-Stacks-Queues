...
${OBJECTDIR}/07RecursiveStringReverse.o: 07RecursiveStringReverse.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/07RecursiveStringReverse.o 07RecursiveStringReverse.c

${OBJECTDIR}/ArrayManipulation.o: ArrayManipulation.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArrayManipulation.o ArrayManipulation.c
