...
${OBJECTDIR}/17TextBombardment.o: 17TextBombardment.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/17TextBombardment.o 17TextBombardment.c
...
${OBJECTDIR}/ReverseIntArray.o: ReverseIntArray.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReverseIntArray.o ReverseIntArray.c
